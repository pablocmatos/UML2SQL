...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matchClasse2Sql():V"/>
		<constant value="A.__matchAtributo2Coluna():V"/>
		<constant value="__exec__"/>
		<constant value="Classe2Sql"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyClasse2Sql(NTransientLink;):V"/>
		<constant value="Atributo2Coluna"/>
		<constant value="A.__applyAtributo2Coluna(NTransientLink;):V"/>
		<constant value="__matchClasse2Sql"/>
		...
		<constant value="3"/>
		<constant value="7:11-7:13"/>
		<constant value="7:11-7:18"/>
		<constant value="7:3-7:18"/>
		<constant value="link"/>
		<constant value="__matchAtributo2Coluna"/>
	...
	<operation name="77">
		...
		<linenumbertable>
			...
			<lne id="85" begin="17" end="19"/>
			<lne id="86" begin="15" end="21"/>
			<lne id="87" begin="24" end="24"/>
			<lne id="88" begin="24" end="25"/>
			<lne id="89" begin="22" end="27"/>
			<lne id="76" begin="8" end="28"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="3" begin="7" end="28"/>
			<lve slot="2" name="74" begin="3" end="28"/>
			<lve slot="0" name="17" begin="0" end="28"/>
			<lve slot="1" name="71" begin="0" end="28"/>
		</localvariabletable>
	</operation>
</asm>
